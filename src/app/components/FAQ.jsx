...
const FAQ = () => {
    return (
        ...
        <div className='bg-stone-100 w-[96%] lg:w-[80%] rounded-3xl mx-auto my-10 py-5' data-aos="flip-left">
            <h3 className='text-3xl md:text-5xl font-bold py-5 w-[86%] lg:w-[96%] mx-auto'>Your questions, answered</h3>
            <div className='w-[90%] lg:w-[98%] mx-auto rounded-2xl '>
                <div className="collapse collapse-arrow mb-5">
                    <input type="checkbox" name="my-accordion-2" />
                    <div className="collapse-title text-lg font-bold">What’s included with YouTube Premium?</div>
                ...
                <div className="collapse collapse-arrow mb-5">
                    <input type="checkbox" name="my-accordion-2" />
                    <div className="collapse-title text-lg font-bold">How do I download videos and music?</div>
                    <div className="collapse-content text-[#606060]">
                ...
                <div className="collapse collapse-arrow mb-5">
                    <input type="checkbox" name="my-accordion-2" />
                    <div className="collapse-title text-lg font-bold">How do I add people to my plan?</div>
                    <div className="collapse-content text-[#606060]">
                ...
                <div className="collapse collapse-arrow mb-5">
                    <input type="checkbox" name="my-accordion-2" />
                    <div className="collapse-title text-lg font-bold">How do I play videos and music in the background?</div>
                    <div className="collapse-content text-[#606060]">
                ...
                <div className="collapse collapse-arrow mb-5">
                    <input type="checkbox" name="my-accordion-2" />
                    <div className="collapse-title text-lg font-bold">What’s the difference between YouTube Premium and YouTube Music Premium?</div>
                    <div className="collapse-content text-[#606060]">
                ...
                <div className="collapse collapse-arrow mb-5">
                    <input type="checkbox" name="my-accordion-2" />
                    <div className="collapse-title text-lg font-bold">How can I cancel my membership?</div>
                    <div className="collapse-content text-[#606060]">
